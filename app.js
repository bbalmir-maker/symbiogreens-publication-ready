const storeKeys = {
  ...
  accessApplications: 'sg_platform_access_applications',
...
const CONTACT_CHANNELS = {
  general: 'info@balponics.com',
  support: 'support@balponics.com',
  sales: 'sales@balponics.com',
  investors: 'investors@balponics.com',
  partners: 'partners@balponics.com',
  projects: 'projects@balponics.com',
  billing: 'billing@balponics.com',
  admin: 'admin@balponics.com',
  founder: 'bbalmir@balponics.com',
  phoneDisplay: '+1 809-487-4196',
  phoneHref: 'tel:+18094874196',
  whatsappDisplay: '+1 849-650-6627',
  whatsappHref: 'https://wa.me/18496506627'
};

const INTERNAL_NOTIFICATION_RECIPIENTS = [CONTACT_CHANNELS.admin];
...
const state = {
  ...
  resetEmail: '',
  investorAccessEmail: '',
  accountApplicationRole: 'customer',
  accountApplicationSubmitted: null,
...
Object.assign(I18N.en, {
  ...
  contactInquiryCards:[
    ['Sales / Quote Request','For hotels, restaurants, villas, chefs, distributors, retailers, and specialty buyers interested in premium fresh supply.'],
    ['Project / Installation Request','For people with land, sites, greenhouse ideas, farm development goals, or local production opportunities.'],
    ['Investor Inquiry','For investment, joint venture, regional development, or strategic collaboration inquiries.'],
    ['Strategic Partnership','For Caribbean, island, tourism, hospitality, or local-market opportunities where the SymbioGreens / Balponics model could be adapted.']
  ],
  ...
  contactInquiryOptions:[['General Inquiry','General Inquiry'],['Customer Support','Customer Support'],['Sales / Quote Request','Sales / Quote Request'],['Investor Inquiry','Investor Inquiry'],['Strategic Partnership','Strategic Partnership'],['Project / Installation Request','Project / Installation Request'],['Billing / Payment','Billing / Payment']],
...
Object.assign(I18N.es, {
  ...
  contactInquiryCards:[
    ['Sales / Quote Request','Para hoteles, restaurantes, villas, chefs, distribuidores, minoristas y compradores especializados interesados en suministro fresco premium.'],
    ['Project / Installation Request','Para personas con terrenos, sitios, ideas de invernaderos, metas de desarrollo agrícola u oportunidades de producción local.'],
    ['Investor Inquiry','Para inversión, joint venture, desarrollo regional o consultas de colaboración estratégica.'],
    ['Strategic Partnership','Para oportunidades caribeñas, insulares, turísticas, hoteleras o de mercado local donde el modelo SymbioGreens / Balponics pueda adaptarse.']
  ],
  ...
  contactInquiryOptions:[['General Inquiry','Consulta general'],['Customer Support','Soporte al cliente'],['Sales / Quote Request','Ventas / Solicitud de cotización'],['Investor Inquiry','Consulta de inversionista'],['Strategic Partnership','Alianza estratégica'],['Project / Installation Request','Solicitud de proyecto / instalación'],['Billing / Payment','Facturación / Pago']],
...
Object.assign(I18N.fr, {
  ...
  contactInquiryCards:[
    ['Sales / Quote Request','Pour hôtels, restaurants, villas, chefs, distributeurs, détaillants et acheteurs spécialisés intéressés par un approvisionnement frais premium.'],
    ['Project / Installation Request','Pour les personnes disposant de terrains, sites, idées de serres, objectifs de ferme ou opportunités de production locale.'],
    ['Investor Inquiry','Pour les demandes d’investissement, coentreprise, développement régional ou collaboration stratégique.'],
    ['Strategic Partnership','Pour les opportunités caribéennes, insulaires, touristiques, hôtelières ou de marchés locaux où le modèle SymbioGreens / Balponics pourrait être adapté.']
  ],
  ...
  contactInquiryOptions:[['General Inquiry','Demande générale'],['Customer Support','Support client'],['Sales / Quote Request','Ventes / Demande de devis'],['Investor Inquiry','Demande d’investisseur'],['Strategic Partnership','Partenariat stratégique'],['Project / Installation Request','Demande de projet / installation'],['Billing / Payment','Facturation / Paiement']],
...
Object.assign(RUNTIME_TRANSLATIONS.es, {
  ...
  "Illustrative model hub: a diversified controlled-environment agriculture campus combining hydroponic towers, microgreens, mushrooms, specialty crops, value-added processing, cold chain, solar-assisted resilience, logistics, visitor experience, and R&D capacity.":"Hub modelo ilustrativo: un campus diversificado de agricultura en ambiente controlado que combina torres hidropónicas, microgreens, hongos, cultivos especiales, procesamiento de valor agregado, cadena de frío, resiliencia asistida por energía solar, logística, experiencia de visitantes y capacidad de I+D.",
...
Object.assign(RUNTIME_TRANSLATIONS.fr, {
  ...
  "Illustrative model hub: a diversified controlled-environment agriculture campus combining hydroponic towers, microgreens, mushrooms, specialty crops, value-added processing, cold chain, solar-assisted resilience, logistics, visitor experience, and R&D capacity.":"Hub modèle illustratif : un campus diversifié d’agriculture en environnement contrôlé combinant tours hydroponiques, microgreens, champignons, cultures spécialisées, transformation à valeur ajoutée, chaîne du froid, résilience assistée par solaire, logistique, expérience visiteurs et capacité R&D.",
...
Object.assign(RUNTIME_TRANSLATIONS.es, {
  ...
  "Seasoned executive and entrepreneur with 20+ years of experience in tourism, hospitality, treasury administration, and regional business development.":"Ejecutiva y emprendedora con más de 20 años de experiencia en turismo, hotelería, administración de tesorería y desarrollo regional.",
  "Finance":"Finanzas",
  "Treasury Administration":"Administración de tesorería",
  "Tourism & Hospitality":"Turismo y hotelería",
  "Real Estate":"Bienes raíces",
  "Caribbean Markets":"Mercados caribeños",
  "Multilingual Leadership":"Liderazgo multilingüe",
  "Pascal B. Hilaire is a seasoned executive, entrepreneur, and finance-oriented business leader with more than two decades of experience across tourism, hospitality, corporate operations, treasury administration, and regional business development.":"Pascal B. Hilaire es una ejecutiva, emprendedora y líder empresarial orientada a las finanzas con más de dos décadas de experiencia en turismo, hotelería, operaciones corporativas, administración de tesorería y desarrollo regional.",
  "Her career includes senior experience with Transat, where she contributed to the development of Caribbean tourism markets, including Cuba and the Dominican Republic. She later became closely involved in Haiti's national tourism development efforts, serving in a senior role within Haiti's Ministry of Tourism, where she contributed to destination promotion, travel-industry coordination, and tourism development initiatives.":"Su carrera incluye experiencia senior en Transat, donde contribuyó al desarrollo de mercados turísticos del Caribe, incluyendo Cuba y República Dominicana. Más tarde participó de cerca en los esfuerzos nacionales de desarrollo turístico de Haití, sirviendo en un cargo senior dentro del Ministerio de Turismo de Haití, donde contribuyó a la promoción de destinos, la coordinación con la industria de viajes y las iniciativas de desarrollo turístico.",
  "Pascal is currently CEO of Explore Caribe and has developed business interests across tourism, hospitality, real estate, and regional partnerships, including ventures connected to the Dominican Republic market. Her professional background combines corporate discipline, entrepreneurial execution, financial responsibility, and deep Caribbean market knowledge.":"Pascal es actualmente CEO de Explore Caribe y ha desarrollado intereses empresariales en turismo, hotelería, bienes raíces y alianzas regionales, incluyendo iniciativas conectadas al mercado de República Dominicana. Su trayectoria profesional combina disciplina corporativa, ejecución emprendedora, responsabilidad financiera y profundo conocimiento del mercado caribeño.",
  "As Chief Financial Officer of SymbioGreens, Pascal brings disciplined financial oversight, treasury responsibility, multilingual communication skills, and strong management experience. Her background in tourism, hospitality, real estate, and regional business development gives SymbioGreens a solid financial and operational foundation as the company develops a premium hydroponic, agri-tourism, and food-resilience platform for Haiti and the wider Caribbean.":"Como Directora Financiera de SymbioGreens, Pascal aporta supervisión financiera disciplinada, responsabilidad de tesorería, habilidades de comunicación multilingüe y sólida experiencia de gestión. Su experiencia en turismo, hotelería, bienes raíces y desarrollo regional brinda a SymbioGreens una base financiera y operativa sólida mientras la compañía desarrolla una plataforma premium de hidroponía, agroturismo y resiliencia alimentaria para Haití y el Caribe en general."
});

Object.assign(RUNTIME_TRANSLATIONS.fr, {
  "Chief Financial Officer":"Directrice Financière",
  "Seasoned executive and entrepreneur with 20+ years of experience in tourism, hospitality, treasury administration, and regional business development.":"Dirigeante expérimentée et entrepreneure avec plus de 20 ans d’expérience dans le tourisme, l’hôtellerie, l’administration de trésorerie et le développement régional.",
  "Finance":"Finance",
  "Treasury Administration":"Administration de trésorerie",
  "Tourism & Hospitality":"Tourisme et hôtellerie",
  "Real Estate":"Immobilier",
  "Caribbean Markets":"Marchés caribéens",
  "Multilingual Leadership":"Leadership multilingue",
  "Pascal B. Hilaire is a seasoned executive, entrepreneur, and finance-oriented business leader with more than two decades of experience across tourism, hospitality, corporate operations, treasury administration, and regional business development.":"Pascal B. Hilaire est une dirigeante expérimentée, entrepreneure et leader d’affaires orientée finance avec plus de deux décennies d’expérience dans le tourisme, l’hôtellerie, les opérations corporatives, l’administration de trésorerie et le développement régional.",
  "Her career includes senior experience with Transat, where she contributed to the development of Caribbean tourism markets, including Cuba and the Dominican Republic. She later became closely involved in Haiti's national tourism development efforts, serving in a senior role within Haiti's Ministry of Tourism, where she contributed to destination promotion, travel-industry coordination, and tourism development initiatives.":"Sa carrière comprend une expérience senior chez Transat, où elle a contribué au développement des marchés touristiques caribéens, notamment Cuba et la République dominicaine. Elle s’est ensuite impliquée de près dans les efforts nationaux de développement touristique d’Haïti, occupant un poste senior au sein du Ministère du Tourisme d’Haïti, où elle a contribué à la promotion des destinations, à la coordination avec l’industrie du voyage et aux initiatives de développement touristique.",
  "Pascal is currently CEO of Explore Caribe and has developed business interests across tourism, hospitality, real estate, and regional partnerships, including ventures connected to the Dominican Republic market. Her professional background combines corporate discipline, entrepreneurial execution, financial responsibility, and deep Caribbean market knowledge.":"Pascal est actuellement CEO d’Explore Caribe et a développé des intérêts d’affaires dans le tourisme, l’hôtellerie, l’immobilier et les partenariats régionaux, y compris des initiatives liées au marché de la République dominicaine. Son parcours professionnel combine discipline corporative, exécution entrepreneuriale, responsabilité financière et connaissance approfondie des marchés caribéens.",
  "As Chief Financial Officer of SymbioGreens, Pascal brings disciplined financial oversight, treasury responsibility, multilingual communication skills, and strong management experience. Her background in tourism, hospitality, real estate, and regional business development gives SymbioGreens a solid financial and operational foundation as the company develops a premium hydroponic, agri-tourism, and food-resilience platform for Haiti and the wider Caribbean.":"Comme Directrice Financière de SymbioGreens, Pascal apporte une supervision financière rigoureuse, une responsabilité de trésorerie, des compétences de communication multilingue et une solide expérience de management. Son expérience dans le tourisme, l’hôtellerie, l’immobilier et le développement régional donne à SymbioGreens une base financière et opérationnelle solide alors que l’entreprise développe une plateforme premium d’hydroponie, d’agrotourisme et de résilience alimentaire pour Haïti et l’ensemble des Caraïbes."
});
...
Object.assign(I18N.en, {
  ...
  homeConnectedCards:{
    ...
    balponics:{title:'Balponics Powers The Technical Model', short:'8+ years of controlled-environment agriculture experience in the Dominican Republic.', detail:'Balponics brings more than eight years of hands-on controlled-environment agriculture experience, including vertical hydroponic towers, NFT systems, aquaponic models, crop trials, nutrient protocols, tropical-climate production methods, supplier relationships, and field-tested operating knowledge.'},
  ...
  homeProductFamilySubtitle:'A diverse portfolio of lettuces, herbs, microgreens, baby greens, edible flowers, gourmet mushrooms, and future value-added products grown with precision, harvested with care, and delivered for freshness.',
  ...
  homeProductFamilyCards:{
    ...
    value:{title:'Value-Added Products', short:'Future dried herbs, teas, seasoning blends, mushroom powders, and packaged specialty products.', detail:'Beyond fresh harvests, the broader Balponics ecosystem explores value-added products such as dried herbs, mushroom powders, and specialty culinary ingredients that can help reduce waste and expand market opportunities.'}
  },
  homeHydroEyebrow:'Why Hydroponics Matters',
  homeHydroTitle:'Smarter Growing. Better Resources. Stronger Food Systems.',
  homeHydroSubtitle:'Closed-loop hydroponic systems support precise control of water, nutrients, pH, and EC while reducing waste and improving consistency for local food resilience.',
  ...
  homeHydroCards:{
    water:{title:'Water Conservation', short:'Recirculated systems deliver water to roots while reducing unnecessary waste.', detail:'Closed-loop hydroponic systems recirculate water and nutrients, allowing precise pH and EC monitoring while supporting efficient production in compact footprints.'},
    ...
    future:{title:'Sustainable Future', short:'Local production strengthens food resilience and community value.', detail:'Hydroponics can shorten supply chains, reduce dependence on long-distance imports, support local jobs, improve resource efficiency, and make premium fresh supply more resilient.'}
  },
...
function routeFromLocation() {
  ...
  return ({'':'landing',home:'landing',about:'brand',products:'products','why-hydroponics':'whyHydroponics',farms:'lasTerrenas','farms-projects':'lasTerrenas','las-terrenas':'lasTerrenas',team:'team',contact:'contact',account:'account','create-account':'account','apply':'account','apply-for-access':'account',register:'register','buyer-login':'login',login:'login',dashboard:'dashboard',catalog:'catalog','forgot-password':'forgotPassword','reset-password':'resetPassword',manager:'manager',admin:'manager',internal:'manager',investors:'investors','investor-preview':'investorPreview','investors-preview':'investorPreview','investor-access':'investorAccess','investor-login':'investorLogin','investor-dashboard':'investorDashboard','investor-model':'investorModel','investor-documents':'investorDocuments','investor-review':'investorReview',privacy:'privacy',terms:'terms',disclaimer:'disclaimer',legal:'legal'}[token]) || 'landing';
}
function hashForRoute(route) {
  return ({landing:'home',brand:'about',whyHydroponics:'why-hydroponics',lasTerrenas:'farms-projects',account:'account',login:'buyer-login',forgotPassword:'forgot-password',resetPassword:'reset-password',manager:'manager',investorPreview:'investor-preview',investorAccess:'investor-access',investorLogin:'investor-login',investorDashboard:'investor-dashboard',investorModel:'investor-model',investorDocuments:'investor-documents',investorReview:'investor-review'}[route]) || route;
}
...
function renderNav() {
  ...
  const items = [['landing',t('home')],['products',t('products')],['lasTerrenas',t('farmsProjects')],['team',t('team')],['brand',t('about')],['investors',t('investors')],['account','Create Account'],['contact',t('contact')]];
  nav.innerHTML = `${items.map(([route,label]) => `<button class="nav-btn ${state.route===route?'active':''}" data-route="${route}">${esc(label)}</button>`).join('')}
    <button class="primary-btn nav-cta" data-route="account">Apply for Access</button>
...
function renderRoute() {
  ...
  if (state.route === 'account') return accountApplicationPanel();
...
function heroPanel() {
  return `<section class="homepage-hero"><div class="homepage-hero-overlay"><div class="hero-copy-overlay"><div class="eyebrow">${esc(t('heroEyebrow'))}</div><h1>${esc(t('heroTitle'))}</h1><strong class="hero-subhead">${esc(t('heroSubhead'))}</strong><p>${esc(t('heroBody'))}</p><div class="hero-actions"><button class="primary-btn" data-route="account">Create Account / Apply for Access</button><button class="ghost-btn" data-action="startProductionSurvey">${esc(t('takeSurvey'))}</button><button class="ghost-btn" data-route="products">${esc(t('explore'))}</button><button class="ghost-btn" data-route="lasTerrenas">${esc(t('farmsProjectsCta'))}</button></div></div></div></section>`;
}
...
function buyerPlanningStepperPanel() {
  ...
  return `<section class="home-premium-panel home-buyer-flow"><div class="home-section-header"><span>${esc(t('howEyebrow'))}</span><h2>${esc(t('homeBuyerFlowTitle'))}</h2><p>${esc(t('homeBuyerFlowSubtitle'))}</p></div><div class="home-stepper">${Object.entries(steps).map(([key,item], index) => `<button type="button" class="home-step-card ${activeKey === key ? 'active' : ''}" data-action="setHomeStep" data-home-step="${esc(key)}"><span class="home-card-index">${String(index + 1).padStart(2,'0')}</span><strong>${esc(item.title)}</strong><p>${esc(item.short)}</p></button>`).join('')}</div><article class="home-detail-panel split"><div><span>${esc(active.title)}</span><p>${esc(active.detail)}</p></div><div class="hero-actions"><button class="primary-btn" data-route="account">Create Account</button><button class="ghost-btn" data-action="startProductionSurvey">${esc(t('homeBuyerFlowCta'))}</button></div></article></section>`;
}
function homeFinalCtaPanel() {
  return `<section class="home-final-cta"><div><h2>${esc(t('homeFinalCtaTitle'))}</h2><p>${esc(t('homeFinalCtaBody'))}</p></div><div class="hero-actions"><button class="primary-btn" data-route="account">Apply for Access</button><button class="ghost-btn" data-action="startProductionSurvey">${esc(t('takeSurvey'))}</button><button class="ghost-btn" data-route="products">${esc(t('explore'))}</button><button class="ghost-btn" data-route="contact">${esc(t('contact'))}</button></div></section>`;
}
...
function aboutPanel() {
  const problemCards = ['Heavy dependence on imported fresh produce','Specialty produce spending days in transit','Exposure to shipping cost variation','Supply disruptions during global crises','Reduced freshness from long transport chains','Inconsistent quality and availability','Limited local control over supply','Lost opportunities for local value creation'];
  ...
  const hydroCards = [['Water Efficiency','Supports more intelligent and efficient water use through recirculation.'],['Better Use of Space','Allows intensive, organized production using towers, NFT, DWC, Dutch buckets, and tray systems.'],['Local Freshness','Enables faster movement from harvest to delivery.'],['More Consistent Quality','Supports premium produce standards for hotels, restaurants, and specialty buyers.'],['Greater Production Control','Supports crop planning, pH and EC monitoring, nutrient protocols, and reliable operating systems.'],['Smarter Risk Management','Reduces some dependence on fragile external supply chains.']];
  ...
  const buildCards = ['Controlled-environment production','Hydroponic towers and NFT systems','Aquaponic and crop trial experience','Nursery and propagation','Premium crop strategy','Harvest and packing','Cold chain and delivery readiness','Technical support and training','Scalable project replication'];
...
function executiveProfiles() {
  return [
    ...
    {
      id:'pascal-b-hilaire',
      name:'Pascal B. Hilaire',
      title:'Chief Financial Officer',
      tagline:'Seasoned executive and entrepreneur with 20+ years of experience in tourism, hospitality, treasury administration, and regional business development.',
      image:'assets/images/team/pascal-b-hilaire.png',
      alt:'Pascal B. Hilaire, Chief Financial Officer of SymbioGreens',
      highlights:['Finance','Treasury Administration','Tourism & Hospitality','Real Estate','Caribbean Markets','Multilingual Leadership'],
      bio:[
        'Pascal B. Hilaire is a seasoned executive, entrepreneur, and finance-oriented business leader with more than two decades of experience across tourism, hospitality, corporate operations, treasury administration, and regional business development.',
        "Her career includes senior experience with Transat, where she contributed to the development of Caribbean tourism markets, including Cuba and the Dominican Republic. She later became closely involved in Haiti's national tourism development efforts, serving in a senior role within Haiti's Ministry of Tourism, where she contributed to destination promotion, travel-industry coordination, and tourism development initiatives.",
        'Pascal is currently CEO of Explore Caribe and has developed business interests across tourism, hospitality, real estate, and regional partnerships, including ventures connected to the Dominican Republic market. Her professional background combines corporate discipline, entrepreneurial execution, financial responsibility, and deep Caribbean market knowledge.',
        'As Chief Financial Officer of SymbioGreens, Pascal brings disciplined financial oversight, treasury responsibility, multilingual communication skills, and strong management experience. Her background in tourism, hospitality, real estate, and regional business development gives SymbioGreens a solid financial and operational foundation as the company develops a premium hydroponic, agri-tourism, and food-resilience platform for Haiti and the wider Caribbean.'
      ]
    },
    {
...
function accountRoleOptions() {
  return {
    customer: {title:'Customer / Buyer', subtitle:'For hotels, chefs, restaurants, retailers, distributors, wellness buyers, and specialty food operators.', interest:'Buyer access', button:'Apply as Customer / Buyer'},
    partner: {title:'Strategic Partner', subtitle:'For regional partners with land, market access, buyer networks, infrastructure, capital, or local operating capacity.', interest:'Strategic partnership', button:'Apply as Strategic Partner'},
    investor: {title:'Investor', subtitle:'For qualified parties requesting private investor review access after screening and approval.', interest:'Investor review access', button:'Request Investor Access'},
    engineer: {title:'Engineer / Technical', subtitle:'For greenhouse, hydroponic, water, solar, construction, logistics, agronomy, and technical collaboration inquiries.', interest:'Technical collaboration', button:'Apply as Engineer / Technical'}
  };
}
function accountApplicationPanel() {
  const roles = accountRoleOptions();
  const active = roles[state.accountApplicationRole] ? state.accountApplicationRole : 'customer';
  const role = roles[active];
  return `<section class="account-entry-page">
    <section class="account-entry-hero">
      <div><div class="eyebrow">Create Account / Apply for Access</div><h1>Create Account / Apply for Access</h1><p>Choose the type of access you are requesting. All applications are reviewed before private portal access is approved.</p><p>Private customer, partner, investor, engineering, document, and admin areas remain hidden until the correct role is approved.</p></div>
      <figure><img src="public/company/production/contact-how-to-connect.png" alt="SymbioGreens access request and approval workflow"></figure>
    </section>
    ${state.accountApplicationSubmitted ? pendingReviewPanel(state.accountApplicationSubmitted) : ''}
    <section class="account-role-section"><div class="section-intro"><h2>Choose Your Access Type</h2><p>Start with the role that best matches your relationship to SymbioGreens and Balponics.</p></div><div class="account-role-grid">${Object.entries(roles).map(([key,item]) => `<button class="account-role-card ${active === key ? 'active' : ''}" type="button" data-action="selectAccountRole" data-role="${esc(key)}"><strong>${esc(item.title)}</strong><p>${esc(item.subtitle)}</p><span>${esc(item.button)}</span></button>`).join('')}</div></section>
    <section class="account-application-layout">
      <form class="form-panel account-application-form" data-form="accountApplication" data-role="${esc(active)}">
        <div class="eyebrow">${esc(role.title)}</div><h2>${esc(role.button)}</h2><p>This public application creates a Pending Review record. It does not grant private portal access or admin access.</p>
        <div class="form-grid">
          <label><span>Full name</span><input name="fullName" required></label>
          <label><span>Company / organization</span><input name="companyName"></label>
          ...
          <label><span>City / region</span><input name="city"></label>
          <label><span>Interest type</span><input name="interestType" value="${esc(role.interest)}" required></label>
          <label class="full"><span>Message / requested access details</span><textarea name="message" required placeholder="Tell us what you are requesting, your role, and any relevant background."></textarea></label>
        </div>
        <label class="checkbox-row"><input type="checkbox" name="reviewConsent" value="yes" required><span>I understand this application will be reviewed before private access is approved.</span></label>
        <button class="primary-btn" type="submit">${esc(role.button)}</button>
        <p class="contact-prototype-note">Status starts as Pending. Admin review is required before any private dashboard access.</p>
      </form>
      <aside class="account-review-note"><h3>What Happens Next</h3><ol><li>Application is submitted as Pending.</li><li>Admin receives the request.</li><li>Admin approves, rejects, or requests more information.</li><li>Approved users receive access only to the matching private portal.</li></ol></aside>
    </section>
  </section>`;
}
function pendingReviewPanel(application) {
  return `<section class="pending-review-confirmation" role="status"><strong>Pending Review</strong><p>Thank you. Your ${esc(application.portalType)} application has been received and is pending review. Our team will review your information and contact you after approval.</p>${application.applicationId ? `<p>Application ID: <code>${esc(application.applicationId)}</code></p>` : '<p>Saved locally until production Supabase is configured.</p>'}</section>`;
}
function contactEmailForInquiry(type) {
  const normalized = String(type || '').toLowerCase();
  if (normalized.includes('support') || normalized.includes('technical')) return CONTACT_CHANNELS.support;
  if (normalized.includes('sales') || normalized.includes('quote') || normalized.includes('buyer')) return CONTACT_CHANNELS.sales;
  if (normalized.includes('investor')) return CONTACT_CHANNELS.investors;
  if (normalized.includes('partnership') || normalized.includes('partner') || normalized.includes('strategic')) return CONTACT_CHANNELS.partners;
  if (normalized.includes('project') || normalized.includes('installation')) return CONTACT_CHANNELS.projects;
  if (normalized.includes('billing') || normalized.includes('payment')) return CONTACT_CHANNELS.billing;
  return CONTACT_CHANNELS.general;
}
...
function contactCompactPanel() {
  return `<section class="contact-section"><div><div class="eyebrow">${esc(t('contact'))}</div><h2>${esc(t('contactTitle'))}</h2><p>${esc(t('contactBody'))}</p><div class="contact-actions"><a class="primary-btn" href="mailto:${CONTACT_CHANNELS.general}">${CONTACT_CHANNELS.general}</a><a class="ghost-btn" href="${CONTACT_CHANNELS.phoneHref}">${CONTACT_CHANNELS.phoneDisplay}</a><a class="ghost-btn" href="${CONTACT_CHANNELS.whatsappHref}" target="_blank" rel="noopener">WhatsApp ${CONTACT_CHANNELS.whatsappDisplay}</a></div></div><form class="form-panel" data-form="contact"><h3>${esc(t('inquiryForm'))}</h3><label><span>${esc(t('name'))}</span><input name="name" required></label><label><span>${esc(t('email'))}</span><input name="email" type="email" required></label><label><span>${esc(t('city'))}</span><input name="region"></label><label><span>${esc(t('message'))}</span><textarea name="message" required></textarea></label><button class="primary-btn">${esc(t('sendInquiry'))}</button></form></section>`;
}
    ...
    <div class="investor-tool-grid">
      ...
      <article class="investor-tool-card">
        ...
        <div class="investor-metric-grid">
          ...
          ${investorMetric('Private-review scenario', 'Available after review', 'Private materials only')}
        </div>
...
async function submitContact(e) {
  ...
  const row = {
    ...
    routing_email:contactEmailForInquiry(fd.inquiry_type || 'General Inquiry'),
  ...
  const result = await window.SymbioGreensBackend?.saveContactMessage?.({
    ...
    language: state.lang,
    source_page: location.hash || hashForRoute(state.route),
    metadata: {local_contact_id: row.id, routing_email: row.routing_email}
  });
...
async function submitInvestor(e) {
  ...
  const inquiryType = cleanText(fd.inquiry_type || 'Investor / Partner');
  const portalType = inquiryType === 'Strategic Partner' ? 'partner' : 'investor';
  const row = {...cleaned, id:uid('inv'), inquiry_type:inquiryType, full_name:cleanText(fd.full_name,160), email:normalizeEmail(fd.email), company:cleanText(fd.company,160), status:'pending', approved_access:false, created_at:new Date().toISOString()};
  const applicationPayload = {
    portalType,
    submissionType: portalType === 'partner' ? 'public_partner_inquiry' : 'public_investor_prequalification',
    fullName: row.full_name,
    companyName: row.company,
    email: row.email,
    phone: cleanText(fd.phone, 80),
    country: cleanText(fd.country, 120),
    city: cleanText(fd.city, 120),
    roleRequested: portalType,
    interestType: inquiryType,
    message: cleanText(fd.message || fd.comments || fd.questions || ''),
    submittedData: {
      ...row,
      source: portalType === 'partner' ? 'public_partner_inquiry' : 'public_investor_interest',
      language: state.lang,
      source_page: location.hash || hashForRoute(state.route)
    }
  };
  ...
  try {
    applicationResult = await window.SymbioApplicationService?.submitApplication?.(applicationPayload);
  } catch (error) {
    console.error("Application insert failed:", error);
    alert('We could not submit your access request right now. Please try again or contact SymbioGreens directly.');
    return;
  }
  if (!applicationResult?.success) {
    console.error("Application insert failed:", applicationResult?.details || applicationResult?.error || applicationResult);
    alert('We could not submit your access request right now. Please try again or contact SymbioGreens directly.');
    return;
  }
  const rows = asArray(readStore(storeKeys.investorRequests, []));
  rows.push({...row, application_id: applicationResult.applicationId});
  writeStore(storeKeys.investorRequests, rows);
  try {
    await window.SymbioGreensBackend?.saveInvestorPrequalification?.({
      ...row,
    ...
    console.warn('Optional investor prequalification mirror failed after applications insert.', error);
  }
...
async function submitAccessApplication(e) {
  e.preventDefault();
  const form = e.target;
  const fd = Object.fromEntries(new FormData(form));
  const portalType = form.dataset.role || state.accountApplicationRole || 'customer';
  if (!['customer','partner','investor','engineer'].includes(portalType)) return alert('Choose a valid access type.');
  if (!isValidEmail(fd.email)) return alert(t('validEmailRequired'));
  if (!cleanText(fd.fullName) || !cleanText(fd.country) || !cleanText(fd.message) || fd.reviewConsent !== 'yes') return alert(t('requiredFieldsMissing'));
  const payload = {
    portalType,
    submissionType: 'main_public_application',
    fullName: cleanText(fd.fullName, 160),
    companyName: cleanText(fd.companyName, 160),
    email: normalizeEmail(fd.email),
    phone: cleanText(fd.phone, 80),
    country: cleanText(fd.country, 120),
    city: cleanText(fd.city, 120),
    roleRequested: portalType,
    interestType: cleanText(fd.interestType, 160),
    message: cleanText(fd.message),
    submittedData: {
      source: 'main_public_account_entry',
      language: state.lang,
      source_page: location.hash || hashForRoute(state.route),
      review_consent: true
    }
  ...
  let result = null;
  try {
    result = await window.SymbioApplicationService?.submitApplication?.(payload);
  } catch (error) {
    console.error("Application insert failed:", error);
    alert('We could not submit your application right now. Please try again or contact SymbioGreens directly.');
    return;
  }
  if (!result?.success) {
    console.error("Application insert failed:", result?.details || result?.error || result);
    alert('We could not submit your application right now. Please try again or contact SymbioGreens directly.');
    return;
  }
  const localRow = {...payload, id: result.applicationId || uid('app'), status: 'pending', created_at: new Date().toISOString()};
  writeStore(storeKeys.accessApplications, [...asArray(readStore(storeKeys.accessApplications, [])), localRow]);
  notifyInternal('admin_new_access_application', `${portalType} access application from ${payload.fullName || payload.email}`);
  state.accountApplicationSubmitted = {
    portalType,
  ...
  form.reset();
  mount();
  setTimeout(() => document.querySelector('.pending-review-confirmation')?.scrollIntoView({behavior:'smooth', block:'center'}), 0);
}
...
document.addEventListener('click', e => {
  ...
  if (action === 'selectAccountRole') { state.accountApplicationRole = actionBtn.dataset.role || 'customer'; state.accountApplicationSubmitted = null; mount(); setTimeout(() => document.querySelector('[data-form="accountApplication"]')?.scrollIntoView({behavior:'smooth', block:'center'}), 0); return; }
...
document.addEventListener('submit', e => {
  ...
  if (form === 'accountApplication') submitAccessApplication(e);
